...
const COLUMNS: Column[] = [
  ...
  { header: "BPJS employee Kesehatan", key: "bpjs_employee_kesehatan", width: 16, money: true, get: (r) => r.entry.bpjs_employee_kesehatan_idr },
  ...
  { header: "BPJS company Kesehatan", key: "bpjs_company_kesehatan", width: 16, money: true, get: (r) => r.entry.bpjs_company_kesehatan_idr },
