    ...
    <main className="mx-auto max-w-6xl px-6 py-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-stretch">
        ...
        <section className="flex-1 rounded-2xl border border-[var(--ikkimo-border)] bg-white p-5">
          ...
          <Link href="/payroll" className="mt-4 w-full block text-center rounded-xl bg-[var(--ikkimo-brand)] py-2.5 text-sm font-semibold text-white hover:bg-[var(--ikkimo-brand-hover)]">
            Start payroll session
          </Link>
        </section>
      </div>
